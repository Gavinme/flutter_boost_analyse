            ...
            children: <Widget>[
              ...
              InkWell(
                child: Container(
                    ...
                    color: Colors.yellow,
                    child: const Text(
                      'Pop with parameter 关闭容器并返回上个页面结果',
                      style: TextStyle(fontSize: 22.0, color: Colors.blue),
                    )),
                onTap: () =>
                    // BoostNavigator.instance.pop({'msg': 'I am from dart ...'}),
              ...
              InkWell(
                  child: Container(
                      ...
                      color: Colors.yellow,
                      child: const Text(
                        'WillPopScope demo (without container)不使用新容器打开 flutter',
                        style: TextStyle(fontSize: 22.0, color: Colors.black),
                      )),
                  onTap: () => BoostNavigator.instance
